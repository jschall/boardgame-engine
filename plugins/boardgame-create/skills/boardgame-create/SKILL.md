...
11. **Instruction text is plain sentences** in everyday words, everywhere; the rulebook states every rule once, in play order, and nothing else: no slogan headings, no fun text, no reading guides, four pages for a light game (`reference/manual.md`).
