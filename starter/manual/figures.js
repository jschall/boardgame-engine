...
module.exports = ({ META, PARTS, S }) => ({
  parts: ['tile-apple', 'tile-pear', 'tile-plum', 'tile-cherry', 'barn', 'farmer-red', 'crow', 'scarecrow-a', 'token-apple', 'token-pear', 'token-plum', 'token-cherry', 'basket-red', 'basket-red-frame', 'base-red', 'order-4', 'order-10', 'floor-base'],
