    ...
    const GAME = {
      ...
      generate(P, lay) {
        ...
        const meta = {
          ...
          INNER_X: F.INNER_X, INNER_Y: F.INNER_Y, OUT_X: F.OUT_X, OUT_Y: F.OUT_Y, FLOOR: F.FLOOR, TABS_X: F.TABS_X, TABS_Y: F.TABS_Y, N_BANDS: F.N_BANDS, NECK_BANDS: F.NECK_BANDS, NECK_OUT_X: F.NECK_OUT_X, NECK_OUT_Y: F.NECK_OUT_Y,   /* the rectangle; a square box has INNER_X = INNER_Y = INNER */
